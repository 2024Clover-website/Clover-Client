...
function REC3sec() {
	...
	function handleREC4click() {
		navigate("/REC/graphic", {
			state: { nameval: name, wishtitle: TitleValue, wish: 0 },
		});
			...
			<div className={styles.TextContainer}>
				...
				<div className={styles.IconContainer}>
					...
					<svg
						...
						onClick={inputCount === 0 ? handlefalse : handleREC4click}
						width="136"
						height="136"
						viewBox="0 0 136 136"
						fill="none"
					...
					<div onClick={handleREC3click} className={styles.prevbt}>
						이전으로
					</div>
				</div>
			</div>
