...
function REC5(){
    ...
    return(
        <div className={styles.container}>
            ...
            <svg className={styles.circle} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className={styles.NextIcon}
                onClick={handleREC6click} width="100" height="100" viewBox="0 0 100 100" fill="none">
